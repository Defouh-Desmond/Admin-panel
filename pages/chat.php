...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><i class="fa fa-comments"></i> Admin Chat</h1>
            </div>
        </div>
            ...
            <div class="chat-panel panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-default btn-xs" id="back-to-contacts" style="display:none;">
                            <i class="fa fa-arrow-left"></i>
                        </button>
                    </div>
                </div>
                <div class="panel-body" id="chat-panel-body" style="padding:5px 10px; position:relative;">
                    <p class="text-center text-muted mt-3">Loading contacts...</p>
                </div>
                <div class="panel-footer" id="chat-panel-footer" style="display:none;">
                    <div class="input-group">
                        <input id="chat-input" type="text" class="form-control input-sm" placeholder="Type your message here..." />
                        <span class="input-group-btn">
                            <button class="btn btn-warning btn-sm" id="chat-send">Send</button>
                        </span>
                    </div>
                </div>
            </div>
...
function contactHtml(adm) {
    ...
    return `
    <div class="contact-item" data-admin-id="${adm.admin_id}" data-name="${adm.full_name}" data-avatar="../uploads/profile/${adm.profile_picture}" 
         style="cursor:pointer; padding:10px; border-bottom:1px solid #f0f0f0; display:flex; align-items:center; justify-content:space-between;">
...
function openChat(name, avatar) {
    ...
    $('#chat-panel-body').fadeOut(200, function() {
        $(this).html('<div id="chat-messages" style="max-height:400px; overflow-y:auto;"></div>').fadeIn(200);
